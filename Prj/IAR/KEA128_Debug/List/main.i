...
void LowerComputer(void)
{
     (*(sprintf_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->sprintf))) ))))((char*)txt,"Ang_Acc:%04d",(int)Ang_Acc);
     LCD_P6x8Str(0,0,txt);
     (*(sprintf_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->sprintf))) ))))((char*)txt,"Ang_IGyro:%04d",(int)Ang_IGyro);
     LCD_P6x8Str(0,1,txt);
     (*(sprintf_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->sprintf))) ))))((char*)txt,"skt:%04d",(int)skt);
     LCD_P6x8Str(0,2,txt);
}
...
{
     Ang_Set-=0.8;   
     if(Ang_Set<112.5)          Ang_Set=112.5;  
}
...
void GetAngle(void)
{
    ...
    aacx=aacx-1122;
    aacz=aacz-1122;                 
    Ang_Acc=atan2(aacx,aacz)*53;    
    Ang_Acc=Ang_Acc-Ang_Set;       
     
    gyrox=gyrox+54;                          
    gyroy=gyroy-18;
    Ang_IGyro=Ang_IGyro+gyroy*(-0.00015);    
    skt=skt+gyroy*(-0.00015);  
    Filter();
    LowerComputer();   
...
void Filter(void)
{
    ...
    Ang_IGyro=Ang_IGyro+Ang_Error*0.01;   
    Ang=Ang_IGyro;
}
...
{    
    if(Speed>0)                   
    {
       ...
       else if(((CHB>-30)&&(CHB<-10))||((CHB>10)&&(CHB<30)))               
       {
          
          CHB-=8;
          Wandao = 2;
       }
       else if(((CHB>-60)&&(CHB<-30))||((CHB>30)&&(CHB<60)))               
       {
     ...
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH0,(uint32)L_Speed);
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH3,(uint32)R_Speed);
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH1,1000);
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH2,1000);
  }
  if(Speed<0)                   
  {
     Speed=1000+Speed-20;       
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH0,1000);
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH3,1000);     
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH1,(uint32)(Speed));
     ftm_pwm_duty(((FTM_Type *)(0x4003A000u)),FTM_CH2,(uint32)(Speed));
  }
}
...
void pit0_irq(void)
{
   LeftWheel_Count = ftm_pulse_get(((FTM_Type *)(0x40038000u)));
   RightWheel_Count = ftm_pulse_get(((FTM_Type *)(0x40039000u)));
   for(int k=0;k<15;k++)
   {
...
void Calculate_Speed(void)
{
   ...
   Check_Speed=(int)(Check_Speed-Speed_Set);                   
   D_Check_Speed=Check_Speed-Check_Speed_Last;          
   Check_Speed_Last=Check_Speed;                        
   I_Check_Speed+=Check_Speed;                          
...
void main(void)
{
   ...
   gpio_init(PTH7,GPI,0);               
   ftm_pulse_init(((FTM_Type *)(0x40038000u)), FTM_PS_1, PTE7);
   ftm_pulse_init(((FTM_Type *)(0x40039000u)), FTM_PS_1, PTE0);
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH0,14000,0); 
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH1,14000,0); 
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH2,14000,0); 
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH3,14000,0); 
   asm(" CPSIE i");;                    
